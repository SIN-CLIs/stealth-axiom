# AGENTS.md — Agenten-Anleitung (stealth-axiom)
...
4. Doc-Health checken: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-axiom`

## Repo-Info

- **Layer**: 🧭 Router
- **Beschreibung**: 3-Tier Router + Adapter-Registry + 5-Strategien Pipeline
